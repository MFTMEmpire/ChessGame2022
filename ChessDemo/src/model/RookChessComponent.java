...
public class RookChessComponent extends ChessComponent {
    ...
    public void loadResource() throws IOException {
        if (ROOK_WHITE == null) {
            ROOK_WHITE = ImageIO.read(new File("D:/Project文档/images/rook-white.png"));
        }

        if (ROOK_BLACK == null) {
            ROOK_BLACK = ImageIO.read(new File("D:/Project文档/images/rook-black.png"));
        }
    }
    ...
    public boolean canMoveTo(ChessComponent[][] chessComponents, ChessboardPoint destination) {
        ...
        if(!chessComponents[destination.getX()][destination.getY()].getChessColor().equals(this.chessColor)) {
...
//        g.drawImage(rookImage, 0, 0, getWidth() - 13, getHeight() - 20, this);
    ...
    public String toString(){
        if (this.getChessColor().equals(ChessColor.BLACK)) return "R";
        return "r";
    }
}
